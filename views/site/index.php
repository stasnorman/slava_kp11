    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                ...
                <!-- Yandex.RTB R-A-1656953-2 -->
                <div id="yandex_rtb_R-A-1656953-2"></div>
                <script>window.yaContextCb.push(()=>{
                Ya.Context.AdvManager.render({
                    renderTo: 'yandex_rtb_R-A-1656953-2',
                    blockId: 'R-A-1656953-2'
                })
                })</script>
            </div>
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Последние проекты</h2>
                ...
                <div class="recommended_items"><!--recommended_items-->
                    <h2 class="title text-center">Лента проектов</h2>
